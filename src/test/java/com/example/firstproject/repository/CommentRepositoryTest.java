...
@DataJpaTest  //리파지터리를 테스트 할 때 씀. 해당 클래스를 JPA와 연동해 테스트 하겠다는 선언
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        {
            // 1. 입력 데이터 준비
            Long articleId= 4L;    // 4번 게시글의 모든 댓글 조회
            // 2. 실제 데이터
        ...
        {
            // 1. 입력 데이터 준비
            Long articleId= 1L;    // 4번 게시글의 모든 댓글 조회
            // 2. 실제 데이터
            List<Comment> comments = commentRepository.findByArticleId(articleId);
            // 3. 예상 데이터
    ...
    void findByNickname() {
        ...
        {
            // 1. 입력 데이터 준비
            String nickname = "Park";   // 4번 게시글의 모든 댓글 조회
            // 2. 실제 데이터
